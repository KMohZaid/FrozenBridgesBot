...
class GameTimers:
    ...
    def __init__(self):
        # Default timer durations (in seconds) - loaded from environment variables
        self.asking_timeout = int(os.getenv("ASKING_TIMEOUT", "180"))  # 3 minutes default
        self.answering_timeout = int(os.getenv("ANSWERING_TIMEOUT", "300"))  # 5 minutes default
        self.dice_roll_timeout = int(os.getenv("DICE_ROLL_TIMEOUT", "60"))  # 1 minute default
        self.accept_reject_timeout = int(os.getenv("ACCEPT_REJECT_TIMEOUT", "120"))  # 2 minutes default
