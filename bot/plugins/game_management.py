...
async def bridgeplan_command(client: Client, message: Message):
    ...
    plan_text = """📝 **Future Development Plans** 📝

**🎯 Upcoming Features:**

✅ **Recently Added:**
• Non-blocking voting system
• Timer displays for all phases
• Full name display in player lists
• Unified player list formatting

**🚧 In Development:**
• Change question requests (answerer can request new question 3x)
• Taunt messages for dice rolls & reveals
• Answer selection from group members
• Question validation system

**🔮 Planned:**
• Game state persistence (survive bot restarts)
• Leaderboards & Achievements
• Question packs (pre-made themed questions)
• Penalty system for give-ups
• Multi-game support per player

**💡 Have ideas?** Let the bot owner know!"""
